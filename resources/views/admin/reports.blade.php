    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gradient-to-b from-purple-700 to-purple-900 text-white flex-shrink-0">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('admin.reports') }}" class="flex items-center px-6 py-3 bg-purple-800 border-l-4 border-white">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm">
                <div class="flex items-center justify-between px-8 py-4">
                    <h2 class="text-2xl font-semibold text-gray-800">Sales & Analytics Reports</h2>
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <p class="font-bold text-blue-600">{{ number_format($event->bookings_count ?? 0) }} tickets</p>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center">
                                            <div class="w-32 bg-gray-200 rounded-full h-2 mr-2">
                                                <div class="bg-gradient-to-r from-blue-500 to-purple-500 h-2 rounded-full" 
                                                     style="width: {{ $topEvents->max('bookings_count') > 0 ? (($event->bookings_count ?? 0) / $topEvents->max('bookings_count') * 100) : 0 }}%">
                                                </div>
                                            </div>
                                            <span class="text-xs text-gray-600">
                                                {{ $topEvents->max('bookings_count') > 0 ? round(($event->bookings_count ?? 0) / $topEvents->max('bookings_count') * 100) : 0 }}%
                                            </span>
                                        </div>
                                    </td>
                                </tr>
